/*
Deployment script for BeHealthy
...
GO
:setvar DatabaseName "BeHealthy"
:setvar DefaultFilePrefix "BeHealthy"
...
CREATE TABLE [dbo].[Alimentos] (
    ...
    [Lipidos]         FLOAT (53)    NOT NULL,
    [Hidratos]        FLOAT (53)    NOT NULL,
    [Sal]             FLOAT (53)    NOT NULL,
    [Fibra]           FLOAT (53)    NOT NULL,
    [Proteina]        FLOAT (53)    NOT NULL,
    [Ferro]           FLOAT (53)    NOT NULL,
...
GO
PRINT N'Creating [dbo].[TipoAlimentos]...';


GO
CREATE TABLE [dbo].[TipoAlimentos] (
    [IDTipoAlimentos] INT           IDENTITY (1, 1) NOT NULL,
    [Descricao]       NVARCHAR (50) NOT NULL,
    PRIMARY KEY CLUSTERED ([IDTipoAlimentos] ASC)
);
...
GO
PRINT N'Creating [dbo].[FK_Alimentos_Utilizadores]...';


GO
ALTER TABLE [dbo].[Alimentos]
    ADD CONSTRAINT [FK_Alimentos_Utilizadores] FOREIGN KEY ([IDUtilizador]) REFERENCES [dbo].[Utilizadores] ([IDUtilizador]);


GO
PRINT N'Creating [dbo].[FK_Alimentos_TipoAlimentos]...';


GO
ALTER TABLE [dbo].[Alimentos]
    ADD CONSTRAINT [FK_Alimentos_TipoAlimentos] FOREIGN KEY ([IDTipoAlimentos]) REFERENCES [dbo].[TipoAlimentos] ([IDTipoAlimentos]);
