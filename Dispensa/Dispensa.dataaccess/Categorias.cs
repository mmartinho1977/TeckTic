...
namespace Pantry.dataaccess
{
    public static class Categorias
    {
        ...
        public static int InsertCategoria(Categoria categoria)
        {
            ...
            query = string.Format("Insert into Categoria (Descricao) Values ('{0}')",  categoria.Descricao);
            ...
            {
                conn.Close();
                throw new Exception("Modulo Data - Metodo Insert", ex);
            }
            catch(Exception)
            {
                throw;
        ...
        public static List<Categoria> SelectAllCategorias()
        {
            ...
            List<entities.Categoria> categorias = new List<Categoria>();
            Categoria c1;
