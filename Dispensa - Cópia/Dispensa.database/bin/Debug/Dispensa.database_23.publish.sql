...
GO
/*
The column [dbo].[Produto].[DataCompra] on table [dbo].[Produto] must be added, but the column has no default value and does not allow NULL values. If the table contains data, the ALTER script will not work. To avoid this issue you must either: add a default value to the column, mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
GO
PRINT N'Altering [dbo].[Produto]...';


GO
ALTER TABLE [dbo].[Produto]
    ADD [DataCompra] DATETIME NOT NULL;
...
INSERT INTO [dbo].[Produto] ([Descricao]
           ...
           ,[CodigoCategoria])
     VALUES
           ('massa', 0.8, 2, 5, 2, GETEDATE(), 1),
           ('arroz', 1.1, 5, 3, 3, GETEDATE(), 1),
           ('courget', 1.9, 3, 3, 3, GETEDATE(), 2)
END
