...
namespace Pantry.dataaccess
{
    ...
    {
        private static string connectionString = "Server = martasqlserver.database.windows.net; Initial Catalog=MyPantry;User ID=mmartinho;Password=Password;"; 
        ...
        public static List<Produto> SelectAllProdutos()
        {
            ...
            command = new SqlCommand("select Codigo, Descricao, Preco, QuantidadeAtual, QuantidadeMinima, QuantidadeMaxima, DataCompra, CodigoCategoria from Produto", conn);
            ...
            while (dataReader.Read())
            {
                ...
                Categorias.ConnectionString = connectionString;
        ...
        public static List<Produto> SelectProdutosByCategoria(string categoria)
        {
            ...
            query = string.Format("select Codigo, Descricao, Preco, CodigoCategoria" +
                "from Produto WHERE CodigoCategoria = '{0}'", categoria);
